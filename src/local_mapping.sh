...
blat -noHead -stepSize=5 -repMatch=2253 -minScore=20 -minIdentity=0 genome ./DAJIN_temp/flanks/left_flank.fa ./DAJIN_temp/flanks/LF_output.psl
...
blat -noHead -stepSize=5 -repMatch=2253 -minScore=20 -minIdentity=0 genome ./DAJIN_temp/flanks/right_flank.fa ./DAJIN_temp/flanks/RF_output.psl
...
twoBitToFa -seq=$chromosome -start=$start -end=$end genome ref_fa
